CREATE MEMORY TABLE MEMBER(USERID VARCHAR(20) NOT NULL PRIMARY KEY,PASS VARCHAR(100),NAME VARCHAR(20),GENDER VARCHAR(1),BIRTH VARCHAR(20),TEL VARCHAR(20),ADDRESS VARCHAR(200))
INSERT INTO MEMBER (USERID, PASS, NAME, GENDER, BIRRTH, TEL, ADDRESS) VALUES ('asd', '1234', '김', '남', '920327', '010', '울산시')
